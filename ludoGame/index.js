...
if(pp[0]==='b'){
    ...
    if(pp.length<2){
        alert('Please Enter the name of at atleast two players !');
        return 0;
    }else{
...
function kill(pno,p){
    ...
    if(p===0){
        ...
        var i;
        for(i=0;i<4;i++){
           var blue = '<span onclick="moveblue(this,'+i+')" class="rp material-icons b" style="z-index: 0;">+</span>'; 
           var green = '<span onclick="movegreen(this,'+i+')" class="rp material-icons g" style="z-index: 0;">+</span>'; 
           
           var yellow = '<span onclick="moveyellow(this,'+i+')" class="rp material-icons y" style="z-index: 0;">+</span>'; 
    ...
    if(p===1){
        ...
        for(i=0;i<4;i++){
           var blue = '<span onclick="moveblue(this,'+i+')" class="rp material-icons b" style="z-index: 0;">+</span>'; 
           var red = '<span onclick="movered(this,'+i+')" class="rp material-icons r" style="z-index: 0;">+</span>'; 
           var yellow = '<span onclick="moveyellow(this,'+i+')" class="rp material-icons y" style="z-index: 0;">+</span>'; 
...
function movered(obj,pno){
    ...
    for(i=0;i<step.length;i++){
        if(rp[pno]===i){
            stepsound.play();
          step[redpath[rp[pno]]].innerHTML="<span onclick='movered(this,"+pno+")' class='rp material-icons r'>+</span>"+prevpl; 
        }else{
            obj.remove();
        }
//        kill();
...
function movegreen(obj,pno){
    ...
    for(i=0;i<step.length;i++){
        if(gp[pno]===i){
            stepsound.play();
          step[greenpath[gp[pno]]].innerHTML="<span onclick='movegreen(this,"+pno+")' class='rp material-icons g'>+</span>"+prevpl; 
        }else{
            obj.remove();
        }
    }
...
function moveblue(obj,pno){
    ...
    for(i=0;i<step.length;i++){
        if(bp[pno]===i){
            stepsound.play();
          step[bluepath[bp[pno]]].innerHTML="<span onclick='moveblue(this,"+pno+")' class='rp material-icons b'>+</span>"+prevpl; 
        }else{
            obj.remove();
        }
    }
...
inoutsound.play();
    ...
    for(i=0;i<step.length;i++){
        if(yp[pno]===i){
            stepsound.play();
          step[yellowpath[yp[pno]]].innerHTML="<span onclick='moveyellow(this,"+pno+")' class='rp material-icons y'>+</span>"+prevpl; 
        }else{
            obj.remove();
        }
    }
